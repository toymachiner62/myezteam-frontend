...
myezteam.controller('DashboardController', ['$scope', '$http', '$location', 'teamsFactory', 'chartService', 'myezteamBase', '$route',
	function($scope, $http, $location, teamsFactory, chartService, myezteamBase, $route) {
